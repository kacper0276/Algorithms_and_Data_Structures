namespace AiSD_IO2_cw5
{
    ...
    // Metody do napisania
    // Wezel4 Znajdz(int liczba) - zwraca wêze³ która ma t¹ wartoœæ, jak dwie te same to zwraca pierwsz¹
    // Wezel4 ZnajdzMin(Wezel4 w) - zaczyna od wêz³a w, znajduje najmniejsz¹ wartoœæ w tym drzewie (Ca³y czas w lewo)
